...
char sensor_id[] = "c23a1d21";

uint8_t devEui[] = {0xE5, 0x27, 0x80, 0x48, 0xF9, 0x5F, 0xBA, 0x5E};
uint8_t appEui[] = {0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01};
uint8_t appKey[] = {0x37, 0xBD, 0xA8, 0x29, 0x97, 0xBB, 0x21, 0x6B, 0x43, 0x42, 0xBC, 0xD0, 0xC7, 0xC3, 0x63, 0x64};
