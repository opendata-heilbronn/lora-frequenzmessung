		...
		lorawanMessage := LoRaWANMessage{
			EndDeviceIDs: EndDeviceIDs{
				...
				ApplicationIDs: ApplicationIDs{
					ApplicationID: "opendata-code-4-heilbronnen-test",
				},
				DevEUI:  "70B3D57ED006EC28",
				DevAddr: "260BEB61",
			},
			ReceivedAt: now,
				...
				RxMetadata: []RxMetadata{
					{
						GatewayIDs: GatewayIDs{
							GatewayID: "cfhn-gw-002",
							EUI:       "B827EBFFFE877DA8",
						},
						Time:        now,
						Timestamp:   timestamp,
						RSSI:        -64,
						...
						SNR:         9.25,
						Location: Location{
							Latitude:  49.1437584965028,
							Longitude: 9.21496457921264,
							Altitude:  57,
					...
					{
						GatewayIDs: GatewayIDs{
							GatewayID: "cfhn-gw-0001",
							EUI:       "B827EBFFFE6D6580",
						},
						Time:        now,
						...
						SNR:         -2.25,
						Location: Location{
							Latitude:  49.14377740057679,
							Longitude: 9.214966235004121,
							Altitude:  187,
							Source:    "SOURCE_REGISTRY",
						},
						ReceivedAt: now,
